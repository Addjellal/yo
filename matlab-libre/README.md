...
make test       # 57 verifications C++ + 41 suites en langage MATLAB
./build/bin/matlibre
```
...
| [`reference.md`](documentation/reference.md) | les 3508 fonctions, avec leur aide — généré |
...
et les messages d'erreur ; 41 suites en langage MATLAB dont une qui
