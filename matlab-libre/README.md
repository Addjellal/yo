...
make test       # 57 verifications C++ + 31 suites en langage MATLAB
./build/bin/matlibre
```
...
- **649 fonctions natives** en C++ : tableaux, mathématiques, algèbre
...
- **2556 fonctions de toolbox** en langage MATLAB, réparties en
...
- **Une aide qui ne ment pas** : 634 fonctions ont leur fiche — syntaxe,
...
et les messages d'erreur ; 31 suites en langage MATLAB dont une qui
