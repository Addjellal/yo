...
make test       # 57 verifications C++ + 32 suites en langage MATLAB
./build/bin/matlibre
```
...
- **2562 fonctions de toolbox** en langage MATLAB, réparties en
...
et les messages d'erreur ; 32 suites en langage MATLAB dont une qui
