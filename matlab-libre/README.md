...
make test       # 57 verifications C++ + 33 suites en langage MATLAB
./build/bin/matlibre
```
...
- **651 fonctions natives** en C++ : tableaux, mathématiques, algèbre
...
- **2629 fonctions de toolbox** en langage MATLAB, réparties en
...
et les messages d'erreur ; 33 suites en langage MATLAB dont une qui
