...
make test       # 57 verifications C++ + 23 suites en langage MATLAB
./build/bin/matlibre
```
...
- **1838 fonctions de toolbox** en langage MATLAB, réparties en
...
et les messages d'erreur ; 23 suites en langage MATLAB dont une qui
