...
make test       # 57 verifications C++ + 30 suites en langage MATLAB
./build/bin/matlibre
```
...
- **2541 fonctions de toolbox** en langage MATLAB, réparties en
...
et les messages d'erreur ; 30 suites en langage MATLAB dont une qui
