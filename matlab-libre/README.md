...
make test       # 57 verifications C++ + 44 suites en langage MATLAB
./build/bin/matlibre
```
...
- **678 fonctions natives** en C++ : tableaux, mathématiques, algèbre
...
- **2920 fonctions de toolbox** en langage MATLAB, réparties en
...
- **Une aide qui ne ment pas** : 661 fonctions ont leur fiche — syntaxe,
...
| [`reference.md`](documentation/reference.md) | les 3598 fonctions, avec leur aide — généré |
...
et les messages d'erreur ; 44 suites en langage MATLAB dont une qui
