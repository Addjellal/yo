...
make test       # 57 verifications C++ + 29 suites en langage MATLAB
./build/bin/matlibre
```
...
- **2441 fonctions de toolbox** en langage MATLAB, réparties en
...
et les messages d'erreur ; 29 suites en langage MATLAB dont une qui
