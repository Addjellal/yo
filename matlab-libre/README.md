...
make test       # 57 verifications C++ + 28 suites en langage MATLAB
./build/bin/matlibre
```
...
- **2338 fonctions de toolbox** en langage MATLAB, réparties en
...
et les messages d'erreur ; 28 suites en langage MATLAB dont une qui
