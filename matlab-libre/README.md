...
make test       # 57 verifications C++ + 27 suites en langage MATLAB
./build/bin/matlibre
```
...
- **2222 fonctions de toolbox** en langage MATLAB, réparties en
...
et les messages d'erreur ; 27 suites en langage MATLAB dont une qui
