...
- **673 fonctions natives** en C++ : tableaux, mathématiques, algèbre
...
- **2902 fonctions de toolbox** en langage MATLAB, réparties en
...
- **Une aide qui ne ment pas** : 656 fonctions ont leur fiche — syntaxe,
...
| [`reference.md`](documentation/reference.md) | les 3575 fonctions, avec leur aide — généré |
