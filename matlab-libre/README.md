...
make test       # 57 verifications C++ + 36 suites en langage MATLAB
./build/bin/matlibre
```
...
- **2742 fonctions de toolbox** en langage MATLAB, réparties en
...
et les messages d'erreur ; 36 suites en langage MATLAB dont une qui
