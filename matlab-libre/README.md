...
make test       # 57 verifications C++ + 26 suites en langage MATLAB
./build/bin/matlibre
```
...
- **2141 fonctions de toolbox** en langage MATLAB, réparties en
...
et les messages d'erreur ; 26 suites en langage MATLAB dont une qui
