...
- **679 fonctions natives** en C++ : tableaux, mathématiques, algèbre
...
- **2978 fonctions de toolbox** en langage MATLAB, réparties en
...
| [`reference.md`](documentation/reference.md) | les 3657 fonctions, avec leur aide — généré |
