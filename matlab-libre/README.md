...
make test       # 57 verifications C++ + 42 suites en langage MATLAB
./build/bin/matlibre
```
...
- **2842 fonctions de toolbox** en langage MATLAB, réparties en
...
| [`reference.md`](documentation/reference.md) | les 3515 fonctions, avec leur aide — généré |
...
et les messages d'erreur ; 42 suites en langage MATLAB dont une qui
