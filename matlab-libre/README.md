...
make test       # 57 verifications C++ + 34 suites en langage MATLAB
./build/bin/matlibre
```
...
- **2630 fonctions de toolbox** en langage MATLAB, réparties en
...
et les messages d'erreur ; 34 suites en langage MATLAB dont une qui
