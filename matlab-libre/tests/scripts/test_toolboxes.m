...
assert(strcmp(simget(simset('Solver', 'DAESSC'), 'Solver'), 'daessc') && ...
       strcmp(simget(simset('Solver', 'oden'), 'Solver'), 'odeN'), ...
       'daessc et odeN, les derniers solveurs de Simulink, sont acceptes');
