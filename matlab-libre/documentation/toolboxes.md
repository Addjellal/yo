...
| `automatique` | Control System Toolbox — systèmes asservis linéaires. | 124 |
...
| `matlab` | MATLAB de base — fonctions écrites dans le langage lui-même. | 458 |
...
Les fonctions natives — 679, écrites en C++ — couvrent le MATLAB de base :
