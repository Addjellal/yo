...
| `automatique` | Control System Toolbox — systèmes asservis linéaires. | 40 |
...
| `matlab` | MATLAB de base — fonctions écrites dans le langage lui-même. | 21 |
...
| `optimisation` | Optimization Toolbox — optimisation sous contraintes. | 10 |
...
| `signal` | Signal Processing Toolbox — traitement du signal. | 68 |
...
Les fonctions natives — 605, écrites en C++ — couvrent le MATLAB de base :
