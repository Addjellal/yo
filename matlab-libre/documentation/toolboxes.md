...
| `matlab` | MATLAB de base — fonctions écrites dans le langage lui-même. | 373 |
...
| `simulink` | Simulink — simulation de schémas-blocs. | 9 |
