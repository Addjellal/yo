...
```
fminbnd  Minimum sur un intervalle.
```
...
```
fsolve  Systeme d'equations non lineaires.
```

## `fzero`

```
fzero  Zero d'une fonction scalaire.
```

## `integral`

```
integral  Quadrature adaptative.
```
...
```
odeset  Options des solveurs d'EDO.
```
