...
- **Une documentation qui ne ment pas** : 618 fonctions ont leur fiche —
...
- **Des tests** : 57 vérifications C++ sur le cœur, 22 suites écrites dans le langage
  ...
  des 633 fonctions natives avec des arguments qu'elle n'attend pas — une
...
6. **Les toolboxes couvrent l'essentiel de leur domaine, pas tout.**
   ...
   108 : construction et conversion des modèles dans les trois
