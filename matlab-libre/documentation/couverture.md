...
- **663 fonctions natives** couvrant le MATLAB de base, **toutes**
  documentées : résumé, description, syntaxes, exemples exécutés par la
  suite de tests et fonctions voisines, dans `toolbox/aide/`.
- **2684 fonctions de toolbox** réparties en 54 modules, écrites dans le
  langage.
...
- **Une documentation qui ne ment pas** : 646 fonctions ont leur fiche —
...
- **Des tests** : 57 vérifications C++ sur le cœur, 22 suites écrites
  ...
  les 646 exemples de l'aide — et 204 vérifications du bureau natif,
  pilotées sans ouvrir de fenêtre. `outils/eprouverNatives.sh` appelle en
  plus chacune des 663 fonctions natives avec des arguments qu'elle
