...
- **665 fonctions natives** couvrant le MATLAB de base, **toutes**
  documentées : résumé, description, syntaxes, exemples exécutés par la
  suite de tests et fonctions voisines, dans `toolbox/aide/`.
- **2716 fonctions de toolbox** réparties en 54 modules, écrites dans le
  langage.
...
- **Des tests** : 57 vérifications C++ sur le cœur, 22 suites écrites
  ...
  plus chacune des 665 fonctions natives avec des arguments qu'elle
