...
- **1579 fonctions de toolbox** réparties en 53 modules, écrites dans le
  langage.
...
6. **Les toolboxes couvrent l'essentiel de leur domaine, pas tout.**
   ...
   appelle d'abord.
   La Wavelet Toolbox en compte 73. Les filtres de Daubechies et les
   ...
   La Statistics and Machine Learning Toolbox en compte 283 : dix-huit
